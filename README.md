...
Este projeto teve como objetivo colocar em prática os aprendizados da Sessão de Introdução à JavaScript ES6 e Testes Unitários, para que fosse criado testes unitários para garantir a boa funcionabilidade das funções, de acordo com o proposto em cada requisito.
